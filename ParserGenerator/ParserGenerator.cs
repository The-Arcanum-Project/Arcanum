...
public class ParserSourceGenerator : IIncrementalGenerator
{
                                ...
                                SourceProductionContext context)
   {
      ...
      foreach (var parserSymbol in parsers.Distinct(SymbolEqualityComparer.Default).OfType<INamedTypeSymbol>())
      {
         ...
         ExtractParseAsAttribute(targetTypeSymbol, propertiesToParse);
      ...
      string fullyQualifiedKeywordClassName)
   {
      ...
      GenerateAutoImplementedParsers(parserSymbol, properties, toolboxSymbol, sb, handwrittenMethods, targetTypeName);
   ...
   private static void ExtractParseAsAttribute(INamedTypeSymbol targetTypeSymbol,
