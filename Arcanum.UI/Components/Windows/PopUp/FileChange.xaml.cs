...
{
    public static readonly DependencyProperty FileChangesProperty = DependencyProperty.Register(
        nameof(FileChanges), typeof(ObservableCollection<FileChangeInfo>), typeof(FileChangeInfo),
    ...
    public static readonly DependencyProperty InfoTextProperty = DependencyProperty.Register(
        nameof(InfoText), typeof(string), typeof(FileChange), new PropertyMetadata("Rename detected in tracked files. Verify changes below:"));
    ...
    public static readonly DependencyProperty ShowReloadSaveButtonsProperty =
        DependencyProperty.Register(nameof(ShowReloadSaveButtons), typeof(bool), typeof(FileChange),
            new(false));
