...
public class FileSearchSettings
{
    ...
    public IQueastorSearchSettings.SortingOptions SortingOption { get; set; } = IQueastorSearchSettings.SortingOptions.Relevance;
    public Enum[] AvailableCategories { get; set; } = Enum.GetValues<Eu5ObjectsRegistry.Eu5ObjectsEnum>().Cast<Enum>().ToArray();
