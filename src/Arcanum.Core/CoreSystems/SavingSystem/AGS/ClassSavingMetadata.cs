...
public class ClassSavingMetadata(TokenType separator,
                                 ...
                                 Action<IAgs, HashSet<PropertySavingMetadata>, IndentedStringBuilder>? savingMethod =
                                    null)
{
   ...
   public Action<IAgs, HashSet<PropertySavingMetadata>, IndentedStringBuilder>? SavingMethod { get; set; } =
      savingMethod;
