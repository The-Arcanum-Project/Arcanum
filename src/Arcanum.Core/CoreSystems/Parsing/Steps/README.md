...
The parsing system is meant to parse the jomini context into blocks and contents which can be processed further. The
parsing system is designed to be modular and extensible, allowing for easy addition of new parsing steps as needed.
