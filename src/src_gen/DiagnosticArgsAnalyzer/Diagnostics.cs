...
public static class Diagnostics
{
   ...
   public static readonly DiagnosticDescriptor ExpectedIEmptyImplementationForINUIObject = new(id: "ARC003",
       title: "INUI implementer should provide an IEmpty<T> implementation",
       messageFormat:
       "The class '{0}' implements INUI but does not provide a static property 'Empty' returning an empty instance of the class. This is recommended for default value handling.",
       category: "Design",
       defaultSeverity: DiagnosticSeverity.Warning,
       isEnabledByDefault: true,
       description:
       "To facilitate default value handling and instantiation, any class that implements INUI should provide a static property 'Empty' that returns an empty instance of the class.");
}