...
public class MapInteractionManager
{
    ...
    public readonly LassoSelectionStrategy LassoSelectionStrategy = new LassoSelectionStrategy();
    public readonly BrushSelectionStrategy BrushSelectionStrategy = new BrushSelectionStrategy();
    ...
    {
        _map = map;
        NavigationStrategy = new MapNavigationStrategy(this);
        RectangleSelectionStrategy = new RectangleSelectionStrategy(this);
