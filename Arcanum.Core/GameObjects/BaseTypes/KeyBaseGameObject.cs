...
/// <see cref="IBaseEu5Object{T}"/> extends multiple interfaces: <br/>
...
public interface IBaseEu5Object<out T> : ISearchable, INUI, IAgs, ICollectionProvider<T>, IEmpty<T>
   where T : IBaseEu5Object<T>;